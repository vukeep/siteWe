...
/**
 * Страница портфолио со всеми работами
 * 
 * Features:
 * - Фильтрация по категориям через tabs
 * - Сетка из видео карточек
 * - Модальное окно с формой при клике на CTA
 * - Адаптивная верстка
 */
...
export default function PortfolioPage() {
  ...
  const portfolioItems =
    selectedCategory === 'all'
      ? getPortfolioItems()
      : getPortfolioItems({ category: selectedCategory })
